...
export const SAINTS = [
  ...
  /* ─── Saints universels très invoqués dans la francophonie ───
     Le critère de cette rubrique est la vénération dans le monde
     francophone, non le lieu de naissance — saint François d'Assise et
     saint Joseph y figuraient déjà. Ceux-ci comptent parmi les plus priés
     en France, en Belgique, au Québec et en Afrique ; quatre d'entre eux
     sont cités par le guide des neuvaines, qui n'avait jusqu'ici aucune
     page vers laquelle renvoyer. */
  {
    slug: 'sainte-rita-de-cascia', name: 'Sainte Rita de Cascia',
    feast: '22 mai', country: 'universel', region: 'Ombrie, Italie',
    patron: 'Patronne des causes désespérées et des situations sans issue',
    desc: "Mariée contre son gré à un homme violent, mère de deux fils, veuve après l'assassinat de son mari, Rita de Cascia (1381-1457) obtint le pardon entre les familles ennemies avant d'entrer au monastère augustin où elle vécut quarante ans. Marquée au front par une plaie de la couronne d'épines, elle est devenue en Europe la sainte des causes difficiles. Sa neuvaine est de loin la plus demandée dans la francophonie, et ses roses sont bénies le 22 mai.",
  },
  {
    slug: 'saint-antoine-de-padoue', name: 'Saint Antoine de Padoue',
    feast: '13 juin', country: 'universel', region: 'Lisbonne et Padoue',
    patron: 'Patron des objets perdus, des pauvres et des prédicateurs',
    desc: "Portugais devenu franciscain, Antoine (1195-1231) fut un prédicateur si recherché qu'on l'écoutait sur les places faute d'églises assez grandes. Docteur de l'Église, il est surtout resté dans la mémoire populaire comme celui que l'on prie pour retrouver ce qui est perdu — un objet, mais aussi la paix ou la foi. Le « pain de saint Antoine », aumône faite aux pauvres en remerciement d'une grâce, reste une pratique vivante.",
  },
  {
    slug: 'saint-jude-thaddee', name: 'Saint Jude Thaddée',
    feast: '28 octobre', country: 'universel', region: 'Terre sainte',
    patron: 'Patron des causes désespérées',
    desc: "Apôtre du Christ, auteur de la brève épître qui porte son nom, Jude Thaddée fut longtemps peu invoqué : on craignait de le confondre avec Judas Iscariote. La tradition veut que ce délaissement lui ait valu de se montrer particulièrement empressé auprès de ceux qui l'appellent. Il est aujourd'hui le saint des situations que l'on croit perdues, prié quand tout a déjà été tenté.",
  },
  {
    slug: 'saint-padre-pio', name: 'Saint Padre Pio de Pietrelcina',
    feast: '23 septembre', country: 'universel', region: 'Pouilles, Italie',
    patron: 'Invoqué pour les malades et dans la confession',
    desc: "Capucin italien (1887-1968), Padre Pio porta les stigmates pendant cinquante ans et passait des journées entières au confessionnal, où l'on venait de toute l'Europe. Il fonda à San Giovanni Rotondo une « Maison du soulagement de la souffrance », hôpital toujours en activité. Canonisé en 2002, il est l'un des saints les plus priés du XXᵉ siècle, notamment pour les malades et pour obtenir la grâce d'une confession sincère.",
  },
  {
    slug: 'saint-michel-archange', name: 'Saint Michel Archange',
    feast: '29 septembre', country: 'universel', region: 'Archange',
    patron: 'Protecteur de l\'Église, patron des soldats et des policiers',
    desc: "Son nom est une question : « Qui est comme Dieu ? » Chef des armées célestes dans l'Écriture, saint Michel est invoqué depuis les premiers siècles comme protecteur contre le mal. Le Mont-Saint-Michel, fondé au VIIIᵉ siècle après son apparition à l'évêque d'Avranches, reste l'un des grands sanctuaires de la chrétienté. La prière de Léon XIII à saint Michel, récitée après la messe pendant des décennies, connaît aujourd'hui un net regain.",
  },
  {
    slug: 'saint-charles-de-foucauld', name: 'Saint Charles de Foucauld',
    feast: '1er décembre', country: 'fr', region: 'Strasbourg et le Sahara',
    patron: 'Frère universel, patron des rencontres entre croyants',
    desc: "Officier français, explorateur du Maroc puis converti à vingt-huit ans, Charles de Foucauld (1858-1916) devint prêtre et s'établit à Tamanrasset, au cœur du Sahara, parmi les Touaregs dont il apprit la langue et composa le dictionnaire. Il ne fit aucun disciple de son vivant et fut tué devant son ermitage. Canonisé en 2022, ce « frère universel » inspire aujourd'hui de nombreuses fraternités, en France comme en Afrique.",
  },
];
